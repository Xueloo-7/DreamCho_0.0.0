...
public class KeySettings : ScriptableObject
{
    ...
    [SerializeField] private List<KeyCode> dash = new List<KeyCode> { KeyCode.Mouse1 };
    public List<KeyCode> Dash { get { return Check(dash); } set { dash = value; } }
    [SerializeField] private List<KeyCode> power = new List<KeyCode> { KeyCode.E };
    public List<KeyCode> Power { get { return Check(power); } set { power = value; } }
    [SerializeField] private List<KeyCode> character = new List<KeyCode> { KeyCode.Q };
    public List<KeyCode> Character { get { return Check(character); } set { character = value; } }
    ...
    [SerializeField] private List<KeyCode> attack = new List<KeyCode> { KeyCode.Mouse0 };
    ...
    [SerializeField] private List<KeyCode> escape = new List<KeyCode> { KeyCode.Escape };
