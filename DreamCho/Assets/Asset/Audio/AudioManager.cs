...
public class AudioManager : Singleton<AudioManager>
{
    ...
    protected override void Awake()
    {
        ...
        Event.onVolumeMainChanged += (float value) =>
        {
            mainV = value; ApplyVolume();
        };
        Event.onVolumeBackgroundChanged += (float value) =>
        {
            musicV = value; ApplyVolume();
        };
        Event.onVolumeSoundChanged += (float value) =>
        {
            soundV = value; ApplyVolume();
        };
        Event.onVolumeFxChanged += (float value) =>
        {
            fxV = value; ApplyVolume();
        };
        Event.onMuteChanged += (bool boolean) =>
        {
            musicSource.mute = boolean;
            soundSource.mute = boolean;
            fxSource.mute = boolean;
        };
    }
